...
```
#Graphs
If we look around , we will find that everything is a network and we have not even begun to look closely. Especially given the social media mania that we are all experiencing today, it does not surt to know a better way to see what surrounds us and to be more aware and informed about our networks. Fortuantely it is really simple to do this in R. In this assignment we will explain some of the graph/network visualization tools to interact with graph visualizations and study some of the graph statistics.
